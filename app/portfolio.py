...
def send_email(name, email, message):
    my_email = "diegooroz22@outlook.com"
    ...
    html_content = """
        <p>Hola JD tienes un mensaje de tu Web:</p>
        <p>Nombre: -name-</p>
        <p>Correo: -email-</p>
        <p>Mensaje: -message-</p>
    """
    mail = Mail(my_email, to_email, "Nuevo mensaje desde la Web", html_content=html_content)
